...
USER_NAME="${SSH_USER:-ata}"
USER_PASS="${SSH_PASSWORD:-ayu}"
...
if [ -n "eyJhIjoiZDZjZjU1ZDVjMzAxZDczOWU1M2RkYTBlMWFiMDg1ODciLCJ0IjoiYjAxNjIzNzAtY2VmNy00MWU0LTk2MzQtMzJiNzQwOTRmMTUyIiwicyI6IllqRTFZalkwTWpBdE1XSTJZaTAwTm1ZNExXSXlNbUV0TkdZMU5ESmxaalUwWkRWayJ9" ]; then
    echo "[*] Menjalankan Cloudflare Tunnel (Low Latency Mode)..."
    cloudflared tunnel run --protocol http2 --url "http://127.0.0.1:$PUBLIC_PORT" --token "eyJhIjoiZDZjZjU1ZDVjMzAxZDczOWU1M2RkYTBlMWFiMDg1ODciLCJ0IjoiYjAxNjIzNzAtY2VmNy00MWU0LTk2MzQtMzJiNzQwOTRmMTUyIiwicyI6IllqRTFZalkwTWpBdE1XSTJZaTAwTm1ZNExXSXlNbUV0TkdZMU5ESmxaalUwWkRWayJ9" &
fi
